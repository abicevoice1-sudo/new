...
const R = {
  ...
  price: 'Shiarishta is free, and we intend to keep the core of it that way.\n\n• Create a profile, set your intentions, browse and express interest — all free, no paywall.\n• Identity verification is included for every member, not sold as an upgrade.\n• Nothing about your privacy is a premium feature.\n\nThere is no paid tier today.',
